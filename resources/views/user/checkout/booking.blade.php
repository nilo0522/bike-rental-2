                ...
                <div class="row">
                    <div class="col-sm-6">
                        <div class="sidebar_widget" id="personal">
                            ...
                            <div class="card-body">
                                <form id="booking-form" action="{{ route('checkout') }}" method="POST"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" type="text" id="fname" name="fname"
                                            ...
                                            pattern=[A-Z\sa-z]{3,20} readonly />
                                    </div>
                        ...
                        <div class="sidebar_widget" id="div-total">
                            @foreach ($bike_details as $bike)
                                ...
                                <span>₱ <input style="width:60px;border:none transparent" type="text" id="bikeprice"
                                        name="bikeprice" value="{{ $bike->bikeprice }}" readonly>
                                </span>

                                <div class="col-xs-12">Rent Days:<input style="width:50px;border:none transparent"
                                        name="rentdays" id="rentdays" readonly /></label></div>
                                <input type="hidden" style="width:60px;border:none transparent" id="sub_total"
                                    name="sub_total" readonly />
                                <div class="col-xs-12">
                                    <div>Full Payment: </div>
                                    <div class="pull-right"><span>₱</span>
                                        <input style="width:60px;border:none transparent" id="fullpayment"
                                            name="fullpayment" readonly />
                                    </div>
                                </div>
                                <div class="col-xs-12">
                                    <div class="form-group">
                                    ...
                                    <div class="pull-right">
                                        <input type="hidden" style="width:85px;border:none transparent" id="transfee"
                                            name="transfee" readonly />
                                    </div>
                                </div>
                                <div class="form-group">
                                    <div class="col-xs-12">
                                        ...
                                        <div class="pull-right">
                                            <span><input type="hidden" style="width:60px;border:none transparent"
                                                    type="text" id="total_amount" name="total_amount" readonly>
                                            </span>
                                        </div>
                                    </div>
                                </div>
                                <div>
                                    <button type="button" class="btn">
                                        <a href="../bikedetail/{{ $bike->id }}"
                                            style="color:inherit;   text-decoration: none;"> Back </a>
                                    </button>
                                    &nbsp;
                        ...
                        <div class="sidebar_widget">
                            ...
                            <div class="card-body">
                                <div class="form-group">
                                    ...
                                    <input name="rent_start_date" id="rent_start_date" class="form-control"
                                        autocomplete="off" data-date-format="yyyy-mm-dd hh:ii" required />
                                </div>
                                <div class="form-group">
                                    <label><strong>Return Date:</strong></label>
                                    <input name="rent_end_date" id="rent_end_date" class="form-control" required
                                        autocomplete="off" data-date-format="yyyy-mm-dd hh:ii" />
                                </div>
                                <div class="form-group">
                                    <label for="pickup">Pick up address</label>
                                    <input class="form-control" id="pickup" name="pickup"
                                        placeholder="Set your pick up address." required />
                                </div>
                            </div>
                        </div>
                    </div>
