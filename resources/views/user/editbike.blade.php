        ...
        <section>
            <div class="uploadcontainer">
                ...
                <form id="contact" action="../updatebike/{{ $data->id }}" method="get">
                    ...
                    <fieldset>
                        <input placeholder="Bike Price Per Day" type="number" name="bikeprice"
                            value="{{ $data->bikeprice }}">
                    </fieldset>
                    ...
                    <fieldset>
                        <input placeholder="biketype" type="text" name="biketype" value="{{ $data->biketype }}" disabled
                            required autofocus>
                    </fieldset>
