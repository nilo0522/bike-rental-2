        ...
        <div class="container">
            <div class="row">
                <div class="col-md-9 col-md-push-3">
                    ...
                    @forelse ($bike_detail as $key=>$data)
                        <div class="product-listing-m gray-bg">
                            ...
                            <div class="product-listing-content">
                                ...
                                <ul>
                                    ...
                                    <li><i class="fa fa-bicycle" aria-hidden="true">&nbsp; Bike type:
                                            {{ $data->biketype }}</i></li>
                                </ul>
                                <p class="list-city">City: {{ $data->location }} </p>

                                <a href="bikedetail/{{ $data->id }} " class="btn">View Details <span
                            ...
                            <form action="search-carresult.php" method="post">
                                ...
                                <div class="form-group">
                                    <button type="submit" class="btn btn-block"><i class="fa fa-search"
                                            aria-hidden="true"></i> Search Bikes</button>
                                </div>
                            </form>
                        </div>
                    </div>
                    ...
                    <div class="sidebar_widget">
                        ...
                        <div class="recent_addedcars">
                            <ul>
                                ...
                                @forelse ($bike_detail as $key=>$data)
                                    <li class="gray-bg">
                                        <div class="recent_post_img"> <a href="bikedetail/{{ $data->id }}"><img
                                                    src="uploads/{{ $data->bikepic }}" alt="image"></a> </div>
                                        <div class="recent_post_title"> <a
                                                href="bikedetail/{{ $data->id }}">{{ $data->bikename }}</a>
