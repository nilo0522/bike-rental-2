        ...
        <div class="tab-content">
                        ...
                        <div class="sidebar_widget" style="border:5px solid #337ab7">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <br>
                                    <button type="text" class="btn btn-info" name="save_prof" id="save_prof">
                            ...
                            <div class="col-md-9 col-md-push-1">
                                @forelse ($BikeDetail as $key=>$data)
                                    <div class="product-listing-m gray-bg">
                                        <div class="product-listing-img"><img src="../uploads/{{ $data->bikepic }} "
                                        ...
                                        <div class="product-listing-content">
                                            ...
                                            <ul>
                                                <li><i class="fa fa-industry" aria-hidden="true"></i>
                                                    {{ $data->bikemodel }} Model</li>
                                                <li><i class="fa fa-bicycle" aria-hidden="true"> {{ $data->biketype }}
                                                        <br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Bike Type</i></li>
                                            </ul>
            ...
            <div class="tab-pane text-style" id="tab3">
                ...
                <div class="uploadcontainer ">
                    <form id="contact" action="{{ route('bike_details.store') }}" method="POST"
                                            ...
                                            @forelse($confirm as $key=>$conf)
                                                @if ($conf->returned_status === 1 && $data->payment_id == $conf->payment_id)
                                                    <span class="badge badge-warning"
                                                        style="background-color:#01ff24;">Confirmed</span>
                                                @elseif($conf->returned_status === Null && $data->payment_id ==
                                                    $conf->payment_id)
                                                    <span class="badge badge-warning"
                                                        style="background-color:#01ff24;">Standy</span>
                                                    asdasd
                                                @endif
                                            @empty
                                            @endforelse
                                                ...
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        <div class="form-group">
                                                            ...
                                                            <textarea class="form-control" rows="3" id="issues"
                                                        ...
                                                        <input class="form-control" type="hidden" id="owner_id"
                                                            name="owner_id" value="{{ $data->user_id }}" />
                                                        <input class="form-control" type="hidden" id="fname" name="fname"
                                                            value="{{ Auth::user()->fname }}" />
                                                        <input class="form-control" type="hidden" id="lname" name="lname"
                                                            value="{{ Auth::user()->lname }}" />
            ...
            <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyBlIYYXEaZzs-6M9rSRgs-pGXlS0Mk9b64&callback=initMap&v=weekly"
                        async></script>
                            ...
                            <tbody>
                                @forelse ($return as $key=>$returned)
                                    <tr>
                                        ...
                                        <td style="text-align:center;">{{ $returned->rentername }}
                                            {{ $returned->renterlname }}</td>
                                        <td style="text-align:center;">{{ $returned->issues }}</td>
                                        <td style="text-align:center;">{{ $returned->meetup }}</td>
                                        <td style="text-align:center;">
                                            <div style="margin:15px">
                                                <button class="btn-sm btn-info" type="button"
                                                    id="returned{{ $returned->returned_id }}">Confirm</button>
                                                <div>
                                        </td>
                                        ...
                                        <div class="modal fade" id="Confirm" tabindex="-1" role="dialog"
                                            ...
                                            <div class="modal-dialog modal-xs" style="width:350px; text-align:center;"
                                                role="document">
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                    ...
                                                    <div class="modal-body">
                                                        <div class="form-group">
                                                            <input type="hidden" class="form-control" rows="5"
                                                                id="returned_status" name="returned_status"
                                                                value="{{ $returned->returned_status }}">
                                                            <input type="hidden" name="returned_id" id="returned_id"
                                                                value="{{ $returned->returned_id }}" />
                                                            <input type="hidden" name="bike_id" id="bike_id"
                                                                value="{{ $returned->id }}" />
                                                            <button type="button" class="btn btn-primary btn-xs"
                                                                id="confirm-return">Confirm</button>
                                                            &nbsp;
                                                            <button type="button" class="btn btn-primary btn-xs"
