    ...
    <div  class="row">
      ...
      <div class="col-md-6">
        ...
        <div class="contact_detail">
          ...
          <ul>
            <li>
              <div class="icon_wrap"><i class="fa fa-map-marker" aria-hidden="true"></i>Cagayan De Oro City</div>
              <div class="contact_info_m"></div>
            </li>
            <li>
              <div class="icon_wrap"><i class="fa fa-phone" aria-hidden="true"></i>+63-956-096-3490</div>
              <div class="contact_info_m"><a href="tel:61-1234-567-90"></a></div>
            </li>
            <li>
              <div class="icon_wrap"><i class="fa fa-envelope-o" aria-hidden="true"></i>kikert03@gmail.com.com</div>
              <div class="contact_info_m"><a href="mailto:kikert03@gmail.com.com"></a></div>
            </li>
          </ul>
        </div>
      </div>
