        ...
        <div class="container">
            <div class="row">
                <div class="col-sm-3 col-md-2">
                    <div class="logo"> <a href="#"><img src="../assets/images/logg.png" alt="image" /></a>
                    </div>
                </div>
                    ...
                    <ul>
                        <li class="dropdown"><a href="#" data-toggle="dropdown" aria-haspopup="true"
                                aria-expanded="false"> <span class="badge badge-danger"
                                    style="background-color: red">{{ auth()->user()->unreadNotifications->count() }}</span><i
                            ...
                            <ul class="dropdown-menu">
                                ...
                                @forelse (auth()->user()->unreadNotifications as $notifications)
                                    <li><a class="dropdow-item">Returned Bike Issue:
                                            {{ $notifications->data['issues'] }}</a></li>
                                @empty
